...
export default function PaymentReceiptPage() {
  ...
  return (
    <div className="space-y-4" data-testid="payment-receipt-page">
      <h1 className="text-2xl font-bold text-slate-900" style={{ fontFamily: "var(--font-heading)" }}>Payment Receipt Entry (R Type)</h1>

      <Card className="border border-slate-200 shadow-sm">
        <CardHeader className="pb-3">
          <CardTitle className="text-lg" style={{ fontFamily: "var(--font-heading)" }}>Quick Receipt Entry</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select value={form.partyCode} onValueChange={(v) => setForm({ ...form, partyCode: v })}>
                  <SelectTrigger className="h-9 mt-1" data-testid="receipt-party-select"><SelectValue placeholder="Select party" /></SelectTrigger>
                  <SelectContent>
              ...
              <div>
                <Label className="text-sm">Against Bill / Ref</Label>
                <Input value={form.voucherRef} onChange={(e) => setForm({ ...form, voucherRef: e.target.value })} className="h-9 mt-1" placeholder="Bill number / reference" />
              </div>
            </div>
