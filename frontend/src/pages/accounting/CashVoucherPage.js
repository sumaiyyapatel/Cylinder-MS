...
export default function CashVoucherPage() {
  ...
  const handleSubmit = (e) => {
    ...
    const isReceipt = form.transactionType === "CASH_RECEIPT";
    saveMut.mutate({
      voucherDate: form.voucherDate,
      transactionType: form.transactionType,
      partyCode: form.partyCode,
      particular: form.particular || (isReceipt ? "Cash receipt" : "Cash payment"),
  ...
  return (
    <div className="space-y-4" data-testid="cash-voucher-page">
      <h1 className="text-2xl font-bold text-slate-900" style={{ fontFamily: "var(--font-heading)" }}>Cash Receipt / Payment</h1>

      <Card className="border border-slate-200 shadow-sm">
        <CardHeader className="pb-3">
          <CardTitle className="text-lg" style={{ fontFamily: "var(--font-heading)" }}>Cash Voucher Entry</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select value={form.partyCode} onValueChange={(v) => setForm({ ...form, partyCode: v })}>
                  <SelectTrigger className="h-9 mt-1" data-testid="cash-party-select"><SelectValue placeholder="Select party" /></SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Input value={form.particular} onChange={(e) => setForm({ ...form, particular: e.target.value })} className="h-9 mt-1" placeholder="Particular" required />
              </div>
              <div>
